...
public class PostgreSqlExceptionHandler implements IPostgreSqlException {
     ...
     *
     * @param e PSQL 异常对象
     * @return 包含详细错误信息的响应实体
     */
    @Override
    @ExceptionHandler(PSQLException.class)
    public ResponseEntity<BaseResponse<HashMap<String, Object>>> handlePostgreSqlException(@NotNull PSQLException e) {
    ...
    public ResponseEntity<BaseResponse<HashMap<String, Object>>> handleDataTruncation(@NotNull DataTruncation e) {
